...
//        rasterizer.frontFace = vk::FrontFace::eClockwise;
    ...
    void createImage(uint32_t width, uint32_t height, vk::SampleCountFlagBits numSample, uint32_t mipLevels, vk::Format format, vk::ImageTiling tiling, vk::ImageUsageFlags usage, vk::MemoryPropertyFlags properties, vk::Image& image, vk::DeviceMemory& imageMemory) {
